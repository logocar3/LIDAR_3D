...
void EV3UARTSensor::check_for_data() {
  ...
  /*Serial.println("\nSoftware serial before status");
  Serial.println(this->status);
  Serial.println("\nSoftware serial before last_nack");
  Serial.println(this->last_nack);
...
int EV3UARTSensor::get_status() {
  //Serial.println("Getting status in");
  //int a = ;
  //delay(100);
  //Serial.println("Getting status out");
  //delay(100);
  return this->status;
}
